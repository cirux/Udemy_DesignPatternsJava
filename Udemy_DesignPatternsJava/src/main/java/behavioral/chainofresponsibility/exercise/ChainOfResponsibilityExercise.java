...
/**
 * You have a game scenario with Goblin and GoblinKing. Rules:
 * <ul>
 * <li>a goblin has base attack & defense = 1</li>
 * <li>when the goblin king is in play, every other goblin gets +1 attack</li>
 * <li>goblins get +1 defense for every other goblin in play</li>
 * </ul>
 * @author ciro
 *
 */
